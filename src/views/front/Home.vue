...
<template>
  <main>
    ...
    <!-- 熱賣商品 -->
    <div
      class="bg-base-300/30 w-full py-20 text-center"
      style="background: url(/assets/img/home_bg4.jpg)"
    >
      <div class="mb-6 max-w-full grid grid-cols-2 md:grid-cols-4 xl:px-40">
        <div class="p-2">
          <div class="avatar placeholder">
            <div
              class="bg-neutral-focus text-neutral-content rounded-full max-w-48"
            >
